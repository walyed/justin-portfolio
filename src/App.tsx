        ...
        <div className="w-full bg-white rounded-lg border border-slate-200 hover:shadow-lg transition-all duration-300 p-8 min-h-[180px]">
          ...
          {currentIssue ? (
            <a href={currentIssue.link || '#'} className="block group">
              <div className="text-sm text-slate-500 font-mono mb-4">{currentIssue.month || currentMonth}</div>
              <h5 className="text-base text-slate-800 font-bold group-hover:text-slate-700 transition-colors">{currentIssue.title}</h5>
            </a>
          ) : (
            ...
            <div className="space-y-5">
              {pastIssues.map((issue: any) => (
                <a key={issue.id} href={issue.link || '#'} className="block group">
                  <div className="text-sm text-slate-500 font-mono mb-3">{issue.month || issue.issue_number || ''}</div>
                  <h5 className="text-base text-slate-800 font-bold group-hover:text-slate-700 transition-colors">{issue.title}</h5>
                </a>
              ))}
            </div>
          ) : (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 relative">
                ...
                <div className="lg:col-span-9 pt-20 lg:pt-6">
                    ...
                    <Section id="community" title="Community & Service" chapter="Chapter 05" color="emerald" borderColor="border-emerald-500">
                        ...
                        <div className="text-sm text-slate-500 font-mono mb-4">{upcomingEvent.month || upcomingMonth}</div>
                        <h5 className="text-base text-slate-800 font-bold group-hover:text-slate-700 transition-colors">{upcomingEvent.title}</h5>
                            ...
                            <div className="text-sm text-slate-500 font-mono mb-3">{event.month || ''}</div>
                            <h5 className="text-base text-slate-800 font-bold group-hover:text-slate-700 transition-colors">{event.title}</h5>
                                        </a>
                                      ))}
                                    </div>
                                  ) : (
                            ...
                            <div className="grid md:grid-cols-3 gap-6">
                              ...
                              <div>
                                ...
                                <ul className="space-y-1 text-slate-600 text-sm">
                                  ...
                                  <li className="text-slate-500">{portfolioData.footer.location}</li>
                                </ul>
                              </div>
