  ...
  return (
    <div className="flex md:flex-row flex-col gap-1 items-start">
      ...
      <div className="flex-1 space-y-6 max-w-sm">
        {/* Current Card - Top */}
        <div className="w-full bg-white rounded-xl border-2 border-slate-200 hover:border-slate-300 hover:shadow-xl transition-all duration-300 p-8 min-h-[180px]">
          <h4 className="text-lg font-black text-slate-900 uppercase tracking-wider mb-6">Current</h4>
          {currentIssue ? (
            <a href={currentIssue.link || '#'} className="block group">
              <div className="text-sm text-slate-600 font-bold font-mono mb-4">{currentIssue.month || currentMonth}</div>
              <h5 className="text-lg text-slate-900 font-black group-hover:text-slate-700 transition-colors">{currentIssue.title}</h5>
            </a>
          ) : (
      ...
      <div className="flex-1 max-w-sm">
        <div className="bg-white rounded-xl border-2 border-slate-200 hover:border-slate-300 hover:shadow-xl transition-all duration-300 p-8 min-h-[180px]">
            ...
            <div className="space-y-5">
              {pastIssues.map((issue: any) => (
                <a key={issue.id} href={issue.link || '#'} className="block group">
                  <div className="text-sm text-slate-600 font-bold font-mono mb-3">{issue.month || issue.issue_number || ''}</div>
                  <h5 className="text-base text-slate-900 font-black group-hover:text-slate-700 transition-colors">{issue.title}</h5>
                </a>
              ))}
            </div>
          ) : (
                          ...
                          return (
                            <div className="flex md:flex-row flex-col gap-1 items-start">
                              ...
                              <div className="flex-1 space-y-6 max-w-sm">
                                {/* Upcoming Card - Top */}
                                <div className="w-full bg-white rounded-xl border-2 border-slate-200 hover:border-slate-300 hover:shadow-xl transition-all duration-300 p-8 min-h-[180px]">
                                  <h4 className="text-lg font-black text-slate-900 uppercase tracking-wider mb-6">Upcoming</h4>
                                  {upcomingEvent ? (
                                    <a href={upcomingEvent.link || '#'} className="block group">
                        <div className="text-sm text-slate-600 font-bold font-mono mb-4">{upcomingEvent.month || upcomingMonth}</div>
                        <h5 className="text-lg text-slate-900 font-black group-hover:text-slate-700 transition-colors">{upcomingEvent.title}</h5>
                            ...
                            <div className="text-sm text-slate-600 font-bold font-mono mb-3">{event.month || ''}</div>
                            <h5 className="text-base text-slate-900 font-black group-hover:text-slate-700 transition-colors">{event.title}</h5>
                                        </a>
                                      ))}
                                    </div>
                                  ) : (
