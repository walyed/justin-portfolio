  ...
  return (
    <div className="grid md:grid-cols-3 gap-4 items-start">
      ...
      <div className="md:col-span-2 space-y-6">
        {/* Current Card - Top */}
        <div className="w-full max-w-sm bg-white rounded-lg border border-indigo-100 hover:shadow-lg transition-all duration-300 p-8 min-h-[180px]">
        ...
        <div className="w-full max-w-sm bg-white rounded-2xl border border-slate-200 shadow-lg overflow-hidden min-h-[280px]">
